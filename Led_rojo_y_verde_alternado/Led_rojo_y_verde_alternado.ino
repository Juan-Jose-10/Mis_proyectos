...
// Variables para temporizadores para el led rojo y verde
uint64_t previous_millis_red = 0;
uint64_t previous_millis_green = 0;

//  tiempo para el led rojo y verde
uint64_t red_interval = 1000;
uint64_t green_interval = 1000;

void setup() {
    // Se configuran los pines como salida de cada led
    Serial.begin(9600);
    pinMode(red_led, OUTPUT);
    pinMode(green_led, OUTPUT);

    // Inicializar el estado de cada led, rojo encendido y verde apagado
